					...
					<div class="panel-body">
						<div class="row">
							<div class="checkout-table-heading">
								<div class="col-md-6"><strong>Khóa học</strong></div>
								<div class="col-md-3 text-right"><strong>Giá</strong></div>
								<div class="col-md-3 text-right"><strong>Tổng</strong></div>
							</div>
						</div>
						<div class="row">
							<div class="ordered-item">
								...
								<div class="col-md-3  text-right">
									<strong>{{ $item->cost }} <img src="/Themes/themeone/assets/images/icon-bank.png" style="width: 30px;"></strong>
								</div>
								<div class="col-md-3  text-right">
								<strong>{{ $item->cost }} <img src="/Themes/themeone/assets/images/icon-bank.png" style="width: 30px;"></strong>
								</div>
