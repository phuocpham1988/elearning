            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <fieldset class="form-group col-md-12">
                        ...
                        <textarea class="form-control" name="description" ng-model="description" required="true" rows="5">
                        </textarea>
                ...
                <div class="buttons text-center">
                    <button class="btn btn-lg btn-success button" ng-disabled="!formQuiz.$valid">
                        {{ $button_name }}
                    </button>
                </div>
                {!! Form::close() !!}
