...
?>
    ...
    <div class="row">
        <fieldset class="form-group col-md-6">
            Thêm vào sau bài học
            {{ Form::text('lms_content_after_bai', $value = $lms_content_after->bai, $attributes = array('class'=>'form-control', 'placeholder' => '',
                'readonly'=>'true'
            )) }}
        </fieldset>
    ...
    <div class="row">
        <fieldset class="form-group col-md-12" ng-if="loai=='2' || loai=='6'">
            {{ Form::label('title', 'Tiêu đề bài học') }}
            <span class="text-red">
            </span>
    ...
    <div class="row">
        ...
        <fieldset class="form-group col-md-6" ng-if="loai=='10'">
            {{ Form::label('Flashcard') }}
            {{ Form::select('flashcard_id', $flashcard, $value = '' , $attributes = array('class'=>'form-control',
              'ng-model'=>'flashcard_id',
              'ng-class'=>'{"has-error": formLms.flashcard_id.$touched && formLms.flashcard_id.$invalid}',
              )) }}
            <div class="validation-error" ng-messages="formLms.flashcard_id.$error">
                {!! getValidationMessage()!!}
            </div>
        </fieldset>
