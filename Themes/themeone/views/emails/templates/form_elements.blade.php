				...
				?>
					 ...
					 <fieldset class="form-group">
 					 ...
 					 <fieldset class="form-group">
						...
						{{ Form::text('subject', $value = null , $attributes = array('class'=>'form-control', 'placeholder' => '',
					...
					<fieldset class="form-group">
						...
						{{ Form::email('from_email', $value = null , $attributes = array('class'=>'form-control', 'placeholder' => '',
					...
					<fieldset class="form-group">
						...
						{{ Form::text('from_name', $value = null , $attributes = array('class'=>'form-control', 'placeholder' => '',
					...
					<fieldset class="form-group">
						...
						{{ Form::textarea('content', $value = null , $attributes = array('class'=>'form-control ckeditor', 'rows'=>'5', 'placeholder' => '',
