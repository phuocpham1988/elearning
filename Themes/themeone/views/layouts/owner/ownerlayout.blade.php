  				...
  				<i class="fa fa-fw fa-window-maximize"></i> {{ getPhrase('dashboard') }} 
					...
					<!-- <li {{ isActive($active_class, 'languages') }}> <a href="{{URL_LANGUAGES_LIST}}">
						...
						<li {{ isActive($active_class, 'lms') }} > 
							...
							Khóa học </a> 
							<ul id="lms" class="collapse sidemenu-dropdown">
								<li><a href="{{ URL_LMS_CATEGORIES }}"> <i class="fa fa-fw fa-random"></i>Danh mục</a></li>
								<li><a href="{{ URL_LMS_CONTENT }}"> <i class="icon-books"></i>Nội dung</a></li>
								<li><a href="{{ URL_LMS_SERIES }}"> <i class="fa fa-fw fa-list-ol"></i>Seri</a></li>
							</ul>
						</li>
						...
						<li {{ isActive($active_class, 'reports') }} > 
							...
							<ul id="reports" class="collapse sidemenu-dropdown">
								<li><a href="{{URL_ONLINE_PAYMENT_REPORTS}}"> <i class="fa fa-fw fa-link"></i>Order</a></li>
