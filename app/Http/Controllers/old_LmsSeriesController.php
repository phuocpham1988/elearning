   ...
   public function __construct()
	...
	public function getDatatable()
	{
	  if(!checkRole(getUserGrade(2)))
	  {
		...
		$records = array();
		$records = LmsSeries::select(['title', 'is_paid', 'cost', 'total_items','slug', 'id', 'updated_at'])
		...
		$link_data = '<div class="dropdown more">
						...
						<ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dLabel">
						   <li><a href="'.URL_LMS_SERIES_UPDATE_SERIES.$records->slug.'"><i class="fa fa-spinner"></i>'.getPhrase("update").'</a></li>
	...
	public function listSeries()
	{
		...
		//echo '<pre>'; print_r($data['series']); echo '</pre>'; exit;
