        ...
        if($login_status) {
           ...
           // echo $role_id; exit;
            switch ($role_id) {
                case 4:
                    // echo 123; exit;
                    return redirect(PREFIX. 'parent/class'); exit;
                    break;
                case 2:
                    return redirect(PREFIX);exit;
                    break;
                case 1:
                    return redirect(PREFIX);exit;
                    break;
                case 5:
                    return redirect(PREFIX. 'home'); exit;
                    break;
                case 6:
                    return redirect(PREFIX. 'home');exit;exit;
                    break;
                case 7:
                    return redirect(PREFIX. 'home');exit;
                    break;
            ...
            if(checkRole(getUserGrade(6)))  {
                ...
                //return redirect(PREFIX. 'lms/exam-categories/list'); 
            }
